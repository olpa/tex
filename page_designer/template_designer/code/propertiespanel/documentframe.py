...
class documentFrame(wx.MiniFrame):
    def __init__(self, parent, *args, **kwds):
        wx.MiniFrame.__init__(self, parent, -1, _(u"Document Data Placeholders"), style=wx.ICONIZE|wx.MINIMIZE|wx.MAXIMIZE|wx.CLOSE_BOX|wx.STAY_ON_TOP|wx.DEFAULT_MINIFRAME_STYLE)

        self.parent = parent
        self.frame = self.parent.parent
        self.safetyMode = self.parent.parent.safetyMode

        self.tree = documenttree.documentTree(self)
